...
<div class="container d-flex justify-content-center align-items-center mt-[1%]">
        <div class="col-md-5 register-container animate__animated animate__fadeInDown text-center">
            ...
            <form action="add_user.php" method="post">
                ...
                <button type="submit" class="btn btn-custom w-100 ">Registrasi</button>
            </form>
